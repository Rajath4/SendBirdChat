...
export const StartScreenShareButton = styled(CallButton)`
  background-color: rgba(168, 168, 168, 0.38);
  background-image: url(/icons/screen-share.svg);
  &:hover {
    background-color: rgba(168, 168, 168, 0.5);
  }
`;

export const StopScreenShareButton = styled(CallButton)`
  background-color: var(--white);
  background-image: url(/icons/stop-screen-share.svg);
  &:hover {
    background-color: rgba(168, 168, 168, 0.5);
  }
`;

export const ShowChatButton = styled(CallButton)`
  background-color: rgba(168, 168, 168, 0.38);
...
export const HideChatButton = styled(CallButton)`
  background-color: var(--white);
  background-image: url(/icons/chat.svg);
  &:hover {
    background-color: rgba(168, 168, 168, 0.5);
