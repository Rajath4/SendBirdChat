...
const CallView: React.FC<CallViewProps> = ({ call }) => {
  ...
  const [isScreenShareEnable, setIsScreenShareEnabled] = useState(false);
  ...
  return (
    <Wrapper>
      <Background>
        <ChatModel
          isOpen={isChatModelOpen}
          call={call}
          title="Chat"
          onRequestClose={() => { setIsChatModelOpen(false) }}
          content={<div></div>}
          footer={{}}
        />
        {
      ...
      <Foreground>
        ...
        <Controls>
          ...
          {
            isNot('ended') && !is('ringing') && !is('dialing') && ([
              isScreenShareEnable
                ? <StopScreenShareButton key="screen-share-end" onClick={() => {
                  setIsScreenShareEnabled(false);
                  call.stopScreenShare();
                }} />
                : <StartScreenShareButton key="screen-share-start" onClick={() => {
                  setIsScreenShareEnabled(true);
                  call.startScreenShare();
                }} />,
              isChatModelOpen
                ? <HideChatButton key="stop-video" onClick={() => setIsChatModelOpen(false)} />
                : <ShowChatButton key="start-video" onClick={() => setIsChatModelOpen(true)} />,
            ])
          }
